...
### Rlab7: Hypothesis testing
### ========================================

# A friend in the US has just given birth to a full term baby weighting  2.91kg. She has been told that is below average and is concerned. Is the weight actually low?

# The distribution of birth weights of 1,096,277 children of non-Hispanic white women in the US in 2013, born at 39-40 weeks’ gestation, with a normal curve with the same mean and standard deviation as the recording weights in the population. A baby weighing 2,910g is shown as the dashed line.
...
# Below 2500 is considered low birth weight
# Below 1500 is considered very low birth weight
pnorm(2500, birth.mean,birth.sd)*100
pnorm(1500, birth.mean,birth.sd)*100
